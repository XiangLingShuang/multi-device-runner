...
popup = Template(r"tpl1742370712113.png", record_pos=(0.008, -0.053), resolution=(720, 1600))
close_popup_btn = Template(r"tpl1742370722473.png", record_pos=(0.314, -0.194), resolution=(720, 1600))
